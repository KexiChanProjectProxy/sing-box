...
type RouteOptions struct {
	...
	DefaultTCPKeepAlive        badoption.Duration                `json:"default_tcp_keep_alive,omitempty"`
	DefaultTCPKeepAliveInterval badoption.Duration               `json:"default_tcp_keep_alive_interval,omitempty"`
}
