...
type DialerOptions struct {
	...
	IPv6SourceAddressRange *badoption.Prefix                 `json:"ipv6_source_address_range,omitempty"`
	IPv6SourceAddressMode  IPv6SourceAddressMode             `json:"ipv6_source_address_mode,omitempty"`
...
type IPv6SourceAddressMode string

const IPv6SourceAddressModeRandom IPv6SourceAddressMode = "random"
